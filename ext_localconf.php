...
call_user_func(
    function (string $extKey) {
        ...
        $GLOBALS['TYPO3_CONF_VARS']['SYS']['formEngine']['formDataGroup']['tcaDatabaseRecord'][\Featdd\Mailer\Form\FormDataProvider\MailerFormFields::class] = [];
        $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['processDatamapClass'][] = \Featdd\Mailer\Hook\DataHandlerHook::class;
        ...
        if (false === is_array($GLOBALS['TYPO3_CONF_VARS']['SYS']['caching']['cacheConfigurations'][\Featdd\Mailer\Service\ConfigurationService::CACHE_KEY_CONFIGURATIONS])) {
