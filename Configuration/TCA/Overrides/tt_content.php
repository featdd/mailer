...
call_user_func(
    function (string $extKey) {
        ...
        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTCAcolumns(
            ...
            [
                ...
                'mailer_receiver_email' => [
                    'exclude' => true,
                    'label' => 'LLL:EXT:' . $extKey . '/Resources/Private/Language/locallang.xlf:tca.receiver_email',
                    'displayCond' => 'FIELD:mailer_form:REQ:true',
                    'config' => [
                        'type' => 'input',
                        'size' => 30,
                        'eval' => 'trim,email',
        ...
        $GLOBALS['TCA']['tt_content']['palettes']['mailer_general'] = [
            ...
            'showitem' => 'mailer_form, mailer_receiver_email',
        ];
